...
([Full diff view](https://github.com/marcvanzee/flax/compare/prerelease..howto-train-subset-layers?diff=split))
```diff
diff --git a/examples/mnist/train.py b/examples/mnist/train.py
index 020838b..bfa72f0 100644
...
@@ -173,18 +190,28 @@ def train(train_ds, test_ds):
...
+        optimizer, base_model, train_ds, batch_size, epoch)
